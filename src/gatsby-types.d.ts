...
type MdxFrontmatter = {
  readonly backdrop: Maybe<File>;
  readonly date: Maybe<Scalars['Date']>;
  readonly hero_attr: Maybe<Scalars['String']>;
  readonly hero_img: Maybe<File>;
  readonly leave_date: Maybe<Scalars['Date']>;
...
type MdxFrontmatter_leave_dateArgs = {
  difference: InputMaybe<Scalars['String']>;
  formatString: InputMaybe<Scalars['String']>;
  fromNow: InputMaybe<Scalars['Boolean']>;
  locale: InputMaybe<Scalars['String']>;
...
type MdxFrontmatterFieldSelector = {
  readonly backdrop: InputMaybe<FileFieldSelector>;
  readonly date: InputMaybe<FieldSelectorEnum>;
  readonly hero_attr: InputMaybe<FieldSelectorEnum>;
  readonly hero_img: InputMaybe<FileFieldSelector>;
  readonly leave_date: InputMaybe<FieldSelectorEnum>;
  ...
  readonly tasks: InputMaybe<FieldSelectorEnum>;
  readonly title: InputMaybe<FieldSelectorEnum>;
  readonly type: InputMaybe<FieldSelectorEnum>;
};

type MdxFrontmatterFilterInput = {
  readonly backdrop: InputMaybe<FileFilterInput>;
  readonly date: InputMaybe<DateQueryOperatorInput>;
  readonly hero_attr: InputMaybe<StringQueryOperatorInput>;
  readonly hero_img: InputMaybe<FileFilterInput>;
  readonly leave_date: InputMaybe<DateQueryOperatorInput>;
...
type MdxFrontmatterSortInput = {
  readonly backdrop: InputMaybe<FileSortInput>;
  readonly date: InputMaybe<SortOrderEnum>;
  readonly hero_attr: InputMaybe<SortOrderEnum>;
  readonly hero_img: InputMaybe<FileSortInput>;
  readonly leave_date: InputMaybe<SortOrderEnum>;
  ...
  readonly tasks: InputMaybe<SortOrderEnum>;
...
type AllBlogsQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly excerpt: string | null, readonly frontmatter: { readonly title: string | null, readonly subtitle: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null, readonly hero_attr: string | null, readonly hero_img: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly fields: { readonly slug: string | null } | null }> } };

type BlogHeaderListQueryVariables = Exact<{ [key: string]: never; }>;


type BlogHeaderListQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string | null, readonly subtitle: string | null, readonly hero_img: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly fields: { readonly slug: string | null } | null }> } };
...
type GetBlogQuery = { readonly mdx: { readonly frontmatter: { readonly title: string | null, readonly subtitle: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null, readonly hero_attr: string | null, readonly hero_img: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };

type GetPortfolioQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type GetPortfolioQuery = { readonly mdx: { readonly id: string, readonly frontmatter: { readonly name: string | null, readonly summary: string | null, readonly link: string | null, readonly skills: ReadonlyArray<string | null> | null, readonly logo: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly backdrop: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null };

type ResumePageQueryVariables = Exact<{ [key: string]: never; }>;


type ResumePageQuery = { readonly projects: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly name: string | null, readonly role: string | null, readonly summary: string | null, readonly start_date: string | null, readonly leave_date: string | null, readonly tasks: ReadonlyArray<string | null> | null } | null }> }, readonly work: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly name: string | null, readonly role: string | null, readonly summary: string | null, readonly start_date: string | null, readonly leave_date: string | null, readonly tasks: ReadonlyArray<string | null> | null } | null }> } };

type BlogPagesQueryVariables = Exact<{ [key: string]: never; }>;


type BlogPagesQuery = { readonly allPosts: { readonly nodes: ReadonlyArray<{ readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null, readonly tags: ReadonlyArray<string | null> | null } | null, readonly internal: { readonly contentFilePath: string | null } }> }, readonly tagsGroup: { readonly group: ReadonlyArray<{ readonly fieldValue: string | null }> } };

type PortfolioPagesQueryVariables = Exact<{ [key: string]: never; }>;


type PortfolioPagesQuery = { readonly allPosts: { readonly nodes: ReadonlyArray<{ readonly fields: { readonly slug: string | null } | null, readonly internal: { readonly contentFilePath: string | null } }> } };
