...
const QuickLinks: FC = () => {
    ...
    return (
        <div className="bg-black md:bg-white p-2 md:fixed right-0 top-[50%] md:-translate-y-1/2 md:rounded-l drop-shadow-lg">
            <h3 className="md:hidden pl-1 text-xl">Social</h3>
