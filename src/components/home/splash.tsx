  ...
  return (
    <section className="h-screen p-4">
      <div className="grid h-full bg-nord-4 dark:bg-nord-1 bg-center rounded-3xl overflow-hidden relative">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-linear-to-t from-black/80 to-transparent flex flex-col justify-center">
          <motion.h2 
            initial={{opacity: 0, y: 100}} 
            whileInView={{opacity: 1, y: 0}}  
            viewport={{once: true}}
            transition={{delay: 0.3, duration: 0.8}}
            className="pointer-events-none whitespace-pre-wrap bg-linear-to-b from-white to-slate-900/10 bg-clip-text text-center text-5xl sm:text-[10rem] font-semibold leading-none text-transparent"
          >
            Zak Dowsett
          </motion.h2>
          <motion.h3
