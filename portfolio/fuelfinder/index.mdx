...
type: "project"
role: "Creator"
summary: "FuelFinder collects the latest price data from fuel stations aking data provided by fuel companies in order to make users more aware of fuel prices in their area to help save them money."
